...
namespace ProyectoMecanica.API.Controllers
{
    ...
    public class ServicioMecanicoController : ControllerBase
    {
        ...
        public ServicioMecanicoController(SignInManager<Usuario> signInManager, UserManager<Usuario> userManager, IUsuarioRepositorio usuarioRepositorio, IOptions<ConfiguracionJWT> opciones)
        {
